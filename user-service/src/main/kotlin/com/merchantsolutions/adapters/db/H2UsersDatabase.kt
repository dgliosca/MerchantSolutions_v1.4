...
fun setupDatabase(connection: Connection) {
    ...
    connection.createStatement().use { statement ->
        ...
        statement.executeUpdate(addTokenFoUser(buyerOne, "00000000-0000-0000-0000-000000000001"))
        statement.executeUpdate(addTokenFoUser(buyerTwo, "00000000-0000-0000-0000-000000000002"))
        statement.executeUpdate(addTokenFoUser(seller, "00000000-0000-0000-0000-000000000003"))
        statement.executeUpdate(addTokenFoUser(backOffice, "00000000-0000-0000-0000-000000000005"))
    }
}
